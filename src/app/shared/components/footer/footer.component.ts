...
@Component({
  ...
  template: `
    <footer
      class="bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800 pt-16 pb-8 transition-colors"
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div class="col-span-1 md:col-span-1">
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400 leading-relaxed">
              Experience the best in modern e-commerce. Quality products, fast delivery, and premium
              support.
            </p>
            <div class="flex space-x-4 mt-6">
              ...
              >
              <a href="#" class="text-gray-400 hover:text-indigo-600 transition-colors"
                ><mat-icon>camera_alt</mat-icon></a
              >
              <a href="#" class="text-gray-400 hover:text-indigo-600 transition-colors"
          ...
          <div>
            ...
            <div class="flex">
              ...
              />
              <button
                class="bg-indigo-600 text-white px-4 py-2 rounded-r-xl hover:bg-indigo-700 transition-colors"
              >
        ...
        <div
          class="border-t border-gray-100 dark:border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400"
        >
